...
export default function RecipeDetails(props) {
    ...
    return (
        <Stack fontFamily="monospace" bg="#E3C16F" pt="1em" margin="0 7em" rounded="xl" fontSize="1.5em" 
            ...
            <Text color="#90323D" fontSize="1.2em">{`This plate costs $ ${recipe.pricePerServing} cents per serving.`}</Text>
